...
/**
 * Represents a "Pilates" session in the gym management system.
...
public class Pilates extends Session {
    /**
     * price ---> The fixed price for a "Pilates" session.
     * limit --->  The maximum number of participants .
     */
    private static int price = 60;
    private static int limit = 30;
    /**
     * Constructs a new "Pilates" session with the specified details.
     ...
     */
    public Pilates(SessionType sessionType, String date, ForumType forumType, Instructor instructor) {
        super(sessionType, date, forumType, instructor);

    }
    /**
     * Returns the price of the "Pilates" session.
